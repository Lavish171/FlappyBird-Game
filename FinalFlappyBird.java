...
public class FalppyBIrd extends ApplicationAdapter {
	...
	public void create () {
        ...
        gameover=new Texture("gameoverphoto.png");
	...
	public void startgame()
    {
        ...
        for(int i=0;i<nooftubes;i++)
        {
            ...
            tubex[i]=Gdx.graphics.getWidth()/2-toptube.getWidth()/2 +Gdx.graphics.getWidth()*4/5+i*distancebetweenthetubes;
	...
	public void render () {
		...
		}//the if block of the game state  (or game stata ==1) is continuing till now
		...
		font.draw(batch,String.valueOf(score),915,2100);
		batch.end();
